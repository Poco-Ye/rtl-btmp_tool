...
/******************************************************************************
 *
 *  Contains the BTLogMsg wrapper routines for BTE.  It routes calls the
 *  appropriate application's BTLogMsg equivalent.
 *
 ******************************************************************************/
...
void
BTLogMsg(UINT32 trace_set_mask, const char *fmt_str, ...)
{
...
BTU_API UINT8 BT_TRANSPORT_SetTraceLevel(UINT8 new_level)
{
   if (new_level != 0xFF)
        btu_cb.trace_level = new_level;
...
void LogMsg_0(UINT32 trace_set_mask, const char *fmt_str) {
    BTLogMsg(trace_set_mask, fmt_str);
}
...
void LogMsg_1(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1) {
    ...
    BTLogMsg(trace_set_mask, fmt_str, p1);
}
...
void LogMsg_2(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1, UINT32 p2) {
    BTLogMsg(trace_set_mask, fmt_str, p1, p2);
}
...
void LogMsg_3(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1, UINT32 p2,
        UINT32 p3) {
    BTLogMsg(trace_set_mask, fmt_str, p1, p2, p3);
}
...
void LogMsg_4(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1, UINT32 p2,
        UINT32 p3, UINT32 p4) {
    BTLogMsg(trace_set_mask, fmt_str, p1, p2, p3, p4);
}
...
void LogMsg_5(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1, UINT32 p2,
    ...
    BTLogMsg(trace_set_mask, fmt_str, p1, p2, p3, p4, p5);
}
...
void LogMsg_6(UINT32 trace_set_mask, const char *fmt_str, UINT32 p1, UINT32 p2,
    ...
    BTLogMsg(trace_set_mask, fmt_str, p1, p2, p3, p4, p5, p6);
}
